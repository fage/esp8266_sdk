...
/* TENSILICA: Unlike glibc's _G_config.h, the version generated while
   building libio for uclibc does not include anything that defines
   __GLIBC__.  It needs to be set for the test below to work correctly.  */
#   include <features.h>
#   endif
#   define __STL_HAS_WCHAR_T
