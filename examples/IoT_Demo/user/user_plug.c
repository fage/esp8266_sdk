...
user_plug_short_press(void)
{
    ...
    save_user_param(PRIV_PARAM_SAVE_SEC, 0, &plug_param, sizeof(struct plug_saved_param));
}
...
user_plug_init(void)
{
    ...
    load_user_param(PRIV_PARAM_SAVE_SEC, 0, &plug_param, sizeof(struct plug_saved_param));
